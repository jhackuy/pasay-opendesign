...
| **FINAL_EVIDENCE_SHA（auto-sync 后的新远程 main SHA）** | `4b0eed31b031039c87ea6e9aa3850f10ce6d1512` (`4b0eed31`) |
| FINAL_EVIDENCE_SHA 含内容 | 三次 auto-sync：① `21d3162` 提交 5 个新浏览器证据文件；② `5711e525` 提交本报告初版；③ `4b0eed31` 提交本报告最终版（含 §三 表 2 中 FINAL_EVIDENCE_SHA 指向自身） |
| 6 个产品/harness blob 在 195efbd ↔ 4b0eed31 之间 | **零差异**（见 §三 · 表 2） |
...
| **FINAL_EVIDENCE_SHA** | `4b0eed31b031039c87ea6e9aa3850f10ce6d1512` |
| 6 个产品/harness blob 一致性 | ✅ 完全一致（195efbd ↔ 工作区 ↔ 4b0eed31） |
...
| **remote committed** | **YES**（FINAL_EVIDENCE_SHA = `4b0eed31`，含 5 个新浏览器证据文件 + 本报告 `DESIGN-021-FIX3-WIN-FINAL.md`） |
| **PASAY_DESIGN_IMPLEMENTATION_SOT_SHA** | **`4b0eed31b031039c87ea6e9aa3850f10ce6d1512`**（= FINAL_EVIDENCE_SHA） |
